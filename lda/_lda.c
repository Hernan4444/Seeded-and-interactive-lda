...
static const char __pyx_k_nu_sum[] = "nu_sum";
...
static const char __pyx_k_sample_topics_interactive[] = "_sample_topics_interactive";
...
static PyObject *__pyx_n_s_nu_sum;
...
static PyObject *__pyx_n_s_sample_topics_interactive;
...
static PyObject *__pyx_pf_3lda_4_lda_2_sample_topics_interactive(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_WS, __Pyx_memviewslice __pyx_v_DS, __Pyx_memviewslice __pyx_v_ZS, __Pyx_memviewslice __pyx_v_nzw, __Pyx_memviewslice __pyx_v_ndz, __Pyx_memviewslice __pyx_v_nz, __Pyx_memviewslice __pyx_v_alpha, __Pyx_memviewslice __pyx_v_eta, __Pyx_memviewslice __pyx_v_rands, __Pyx_memviewslice __pyx_v_SW, __Pyx_memviewslice __pyx_v_nzs, __Pyx_memviewslice __pyx_v_nu); /* proto */
static PyObject *__pyx_pf_3lda_4_lda_4_loglikelihood(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_nzw, __Pyx_memviewslice __pyx_v_ndz, __Pyx_memviewslice __pyx_v_nz, __Pyx_memviewslice __pyx_v_nd, double __pyx_v_alpha, double __pyx_v_eta); /* proto */
...
static char __pyx_doc_3lda_4_lda__sample_topics[] = "\n    WS: lista con cada palabra entre todos los documentos\n    DS: lista con el documento asociado a cada palabra\n    ZS: lista con el t\303\263pico asociaddo a cada palabra\n    nzw: Matriz de t\303\263picos (filas) por palabras (columna)\n    ndz: Matriz de documento por t\303\263pico\n    nz: Lista, cantidad de palabras asignadas al t\303\263pico\n\n    alpha y eta lista de hiperparametros para distribuci\303\263n\n    rands: lista de n\303\272meros random (entre 0 y 1) para generar valores aleatorios.\n    Ej: (2 t\303\263picos)\n        Doc0: \"a b\"\n        Doc1: \"c d\"\n        Doc2: \"a d\"\n        -------------\n        WS: [a, b, c, d, a, d]\n        DS: [0, 0, 1, 1, 2, 2]\n        ZS: [0, 1, 1, 0, 1, 0] T\303\263picos puestos al azar\n        \n               a b c d\n        nzw: [ 1 0 0 2   topico 0\n               1 1 1 0 ] topico 1\n\n              T0  T1\n        ndz: [ 1   1    Doc0\n               1   1    Doc1\n               1   1 ]  Doc2\n\n             T0  T1\n        nz: [ 3   3]\n    \n    ";
static PyMethodDef __pyx_mdef_3lda_4_lda_1_sample_topics = {"_sample_topics", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3lda_4_lda_1_sample_topics, METH_VARARGS|METH_KEYWORDS, __pyx_doc_3lda_4_lda__sample_topics};
 ...
 */
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_MemoryError, __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 82, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_Raise(__pyx_t_2, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *             z = ZS[i] # Tpico             # <<<<<<<<<<<<<<
 * 
 *             dec(nzw[z, w]) # Desasignar dicha palabra al tpico
 */
 ...
 * 
 *             dec(nzw[z, w]) # Desasignar dicha palabra al tpico             # <<<<<<<<<<<<<<
 *             dec(ndz[d, z]) # Desasignar dicho tpico al documento
 *             dec(nz[z]) # Disminuir palabras totales del tpico
 */
 ...
 *                 # Falta la divisin (nzw[k,*] + K*alpha[k]), pero es constante
 ...
 */
            ...
            __pyx_v_dist_cum = (__pyx_v_dist_cum + ((((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ndz.data + __pyx_t_20 * __pyx_v_ndz.strides[0]) ) + __pyx_t_21 * __pyx_v_ndz.strides[1]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_22 * __pyx_v_alpha.strides[0]) )))) * ((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nzw.data + __pyx_t_23 * __pyx_v_nzw.strides[0]) ) + __pyx_t_24 * __pyx_v_nzw.strides[1]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_eta.data + __pyx_t_25 * __pyx_v_eta.strides[0]) ))))) / ((*((int *) ( /* dim=0 */ (__pyx_v_nz.data + __pyx_t_26 * __pyx_v_nz.strides[0]) ))) + __pyx_v_eta_sum)));
 ...
 *                 dist_sum[k] = dist_cum             # <<<<<<<<<<<<<<
 *             """
 *             Puede que el ltimo valor de la lista no sea 1.
 */
 ...
 *             z_new = searchsorted(dist_sum, n_topics, r) # Buscar tpico
 * 
 */
 ...
 *             z_new = searchsorted(dist_sum, n_topics, r) # Buscar tpico             # <<<<<<<<<<<<<<
 * 
 *             ZS[i] = z_new  # Asignar nuevo tpico
 */
 ...
 * 
 *             ZS[i] = z_new  # Asignar nuevo tpico             # <<<<<<<<<<<<<<
 *             inc(nzw[z_new, w]) # Aumentar la palabra del tpico
 *             inc(ndz[d, z_new]) # Aumentar el tpico del documento
 */
 ...
 *             inc(nzw[z_new, w]) # Aumentar la palabra del tpico             # <<<<<<<<<<<<<<
 *             inc(ndz[d, z_new]) # Aumentar el tpico del documento
 *             inc(nz[z_new]) # aumentar cantidad de palabras asociadas al tpico
 */
...
/* Python wrapper */
static PyObject *__pyx_pw_3lda_4_lda_3_sample_topics_interactive(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_3lda_4_lda_2_sample_topics_interactive[] = "\n    WS: lista con cada palabra entre todos los documentos\n    DS: lista con el documento asociado a cada palabra\n    ZS: lista con el t\303\263pico asociaddo a cada palabra\n    SW: lista con el seed asociaddo a cada palabra, -1 si no hay seed\n    nzs: Matriz de t\303\263picos (filas) por seed (columna)\n    nzw: Matriz de t\303\263picos (filas) por palabras (columna)\n    ndz: Matriz de documento por t\303\263pico\n    nz: Lista, cantidad de palabras asignadas al t\303\263pico\n\n    alpha, eta, nu lista de hiperparametros para distribuci\303\263n\n    nu es una lista de tuplas, cada tupla es de la forma (nu, len(seed[s]))\n    rands: lista de n\303\272meros random (entre 0 y 1) para generar valores aleatorios.\n    \n    ";
static PyMethodDef __pyx_mdef_3lda_4_lda_3_sample_topics_interactive = {"_sample_topics_interactive", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3lda_4_lda_3_sample_topics_interactive, METH_VARARGS|METH_KEYWORDS, __pyx_doc_3lda_4_lda_2_sample_topics_interactive};
static PyObject *__pyx_pw_3lda_4_lda_3_sample_topics_interactive(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_WS = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_DS = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_ZS = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_nzw = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  __Pyx_memviewslice __pyx_v_eta = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_rands = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_SW = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_nzs = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_nu = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("_sample_topics_interactive (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_WS,&__pyx_n_s_DS,&__pyx_n_s_ZS,&__pyx_n_s_nzw,&__pyx_n_s_ndz,&__pyx_n_s_nz,&__pyx_n_s_alpha,&__pyx_n_s_eta,&__pyx_n_s_rands,&__pyx_n_s_SW,&__pyx_n_s_nzs,&__pyx_n_s_nu,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_DS)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_sample_topics_interactive", 1, 12, 12, 1); __PYX_ERR(0, 129, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ZS)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics_interactive", 1, 12, 12, 2); __PYX_ERR(0, 129, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nzw)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics_interactive", 1, 12, 12, 3); __PYX_ERR(0, 129, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ndz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics_interactive", 1, 12, 12, 4); __PYX_ERR(0, 129, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics_interactive", 1, 12, 12, 5); __PYX_ERR(0, 129, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_alpha)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics_interactive", 1, 12, 12, 6); __PYX_ERR(0, 129, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_eta)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics_interactive", 1, 12, 12, 7); __PYX_ERR(0, 129, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_rands)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics_interactive", 1, 12, 12, 8); __PYX_ERR(0, 129, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_SW)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics_interactive", 1, 12, 12, 9); __PYX_ERR(0, 129, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nzs)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics_interactive", 1, 12, 12, 10); __PYX_ERR(0, 129, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 11:
        if (likely((values[11] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nu)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics_interactive", 1, 12, 12, 11); __PYX_ERR(0, 129, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_sample_topics_interactive") < 0)) __PYX_ERR(0, 129, __pyx_L3_error)
      }
    ...
    __pyx_v_WS = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_WS.memview)) __PYX_ERR(0, 129, __pyx_L3_error)
    __pyx_v_DS = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_DS.memview)) __PYX_ERR(0, 129, __pyx_L3_error)
    __pyx_v_ZS = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ZS.memview)) __PYX_ERR(0, 129, __pyx_L3_error)
    __pyx_v_nzw = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nzw.memview)) __PYX_ERR(0, 129, __pyx_L3_error)
    __pyx_v_ndz = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ndz.memview)) __PYX_ERR(0, 129, __pyx_L3_error)
    __pyx_v_nz = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nz.memview)) __PYX_ERR(0, 129, __pyx_L3_error)
    __pyx_v_alpha = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[6], PyBUF_WRITABLE); if (unlikely(!__pyx_v_alpha.memview)) __PYX_ERR(0, 130, __pyx_L3_error)
    __pyx_v_eta = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[7], PyBUF_WRITABLE); if (unlikely(!__pyx_v_eta.memview)) __PYX_ERR(0, 130, __pyx_L3_error)
    __pyx_v_rands = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[8], PyBUF_WRITABLE); if (unlikely(!__pyx_v_rands.memview)) __PYX_ERR(0, 130, __pyx_L3_error)
    __pyx_v_SW = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[9], PyBUF_WRITABLE); if (unlikely(!__pyx_v_SW.memview)) __PYX_ERR(0, 130, __pyx_L3_error)
    __pyx_v_nzs = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[10], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nzs.memview)) __PYX_ERR(0, 130, __pyx_L3_error)
    __pyx_v_nu = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[11], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nu.memview)) __PYX_ERR(0, 130, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_sample_topics_interactive", 1, 12, 12, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 129, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("lda._lda._sample_topics_interactive", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3lda_4_lda_2_sample_topics_interactive(__pyx_self, __pyx_v_WS, __pyx_v_DS, __pyx_v_ZS, __pyx_v_nzw, __pyx_v_ndz, __pyx_v_nz, __pyx_v_alpha, __pyx_v_eta, __pyx_v_rands, __pyx_v_SW, __pyx_v_nzs, __pyx_v_nu);
...
static PyObject *__pyx_pf_3lda_4_lda_2_sample_topics_interactive(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_WS, __Pyx_memviewslice __pyx_v_DS, __Pyx_memviewslice __pyx_v_ZS, __Pyx_memviewslice __pyx_v_nzw, __Pyx_memviewslice __pyx_v_ndz, __Pyx_memviewslice __pyx_v_nz, __Pyx_memviewslice __pyx_v_alpha, __Pyx_memviewslice __pyx_v_eta, __Pyx_memviewslice __pyx_v_rands, __Pyx_memviewslice __pyx_v_SW, __Pyx_memviewslice __pyx_v_nzs, __Pyx_memviewslice __pyx_v_nu) {
  ...
  __Pyx_RefNannySetupContext("_sample_topics_interactive", 0);
 ...
 *         for i in range(eta.shape[0]):
 */
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_MemoryError, __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_Raise(__pyx_t_2, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
          ...
          __pyx_v_s = (*((int *) ( /* dim=0 */ (__pyx_v_SW.data + __pyx_t_12 * __pyx_v_SW.strides[0]) )));
 ...
 */
          ...
          (void)((--(*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nzw.data + __pyx_t_13 * __pyx_v_nzw.strides[0]) ) + __pyx_t_14 * __pyx_v_nzw.strides[1]) )))));
 ...
 */
          ...
          __pyx_t_16 = __pyx_v_z;
          (void)((--(*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ndz.data + __pyx_t_15 * __pyx_v_ndz.strides[0]) ) + __pyx_t_16 * __pyx_v_ndz.strides[1]) )))));
 ...
 *                 dec(nzs[z, s]) # Desasignar seed al tpico.
 */
 ...
 */
            ...
            __pyx_t_21 = 1;
            __pyx_v_nu_sum = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nu.data + __pyx_t_18 * __pyx_v_nu.strides[0]) ) + __pyx_t_19 * __pyx_v_nu.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nu.data + __pyx_t_20 * __pyx_v_nu.strides[0]) ) + __pyx_t_21 * __pyx_v_nu.strides[1]) ))));
 ...
 */
            ...
            (void)((--(*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nzs.data + __pyx_t_22 * __pyx_v_nzs.strides[0]) ) + __pyx_t_23 * __pyx_v_nzs.strides[1]) )))));
 ...
 */
              ...
              __pyx_v_dist_cum = (__pyx_v_dist_cum + ((((((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ndz.data + __pyx_t_27 * __pyx_v_ndz.strides[0]) ) + __pyx_t_28 * __pyx_v_ndz.strides[1]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_29 * __pyx_v_alpha.strides[0]) )))) * ((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nzs.data + __pyx_t_30 * __pyx_v_nzs.strides[0]) ) + __pyx_t_31 * __pyx_v_nzs.strides[1]) ))) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nu.data + __pyx_t_32 * __pyx_v_nu.strides[0]) ) + __pyx_t_33 * __pyx_v_nu.strides[1]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_eta.data + __pyx_t_34 * __pyx_v_eta.strides[0]) )))))) / ((*((int *) ( /* dim=0 */ (__pyx_v_nz.data + __pyx_t_35 * __pyx_v_nz.strides[0]) ))) + __pyx_v_eta_sum)) * ((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nzw.data + __pyx_t_36 * __pyx_v_nzw.strides[0]) ) + __pyx_t_37 * __pyx_v_nzw.strides[1]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nu.data + __pyx_t_38 * __pyx_v_nu.strides[0]) ) + __pyx_t_39 * __pyx_v_nu.strides[1]) ))))) / ((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nzs.data + __pyx_t_40 * __pyx_v_nzs.strides[0]) ) + __pyx_t_41 * __pyx_v_nzs.strides[1]) ))) + __pyx_v_nu_sum)));
 ...
 */
              ...
              __pyx_v_dist_cum = (__pyx_v_dist_cum + ((((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ndz.data + __pyx_t_42 * __pyx_v_ndz.strides[0]) ) + __pyx_t_43 * __pyx_v_ndz.strides[1]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_44 * __pyx_v_alpha.strides[0]) )))) * ((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nzw.data + __pyx_t_45 * __pyx_v_nzw.strides[0]) ) + __pyx_t_46 * __pyx_v_nzw.strides[1]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_eta.data + __pyx_t_47 * __pyx_v_eta.strides[0]) ))))) / ((*((int *) ( /* dim=0 */ (__pyx_v_nz.data + __pyx_t_48 * __pyx_v_nz.strides[0]) ))) + __pyx_v_eta_sum)));
 ...
 * 
 */
          __pyx_t_49 = (__pyx_v_i % __pyx_v_n_rand);
          __pyx_v_r = ((*((double *) ( /* dim=0 */ (__pyx_v_rands.data + __pyx_t_49 * __pyx_v_rands.strides[0]) ))) * __pyx_v_dist_cum);
 ...
 */
          ...
          *((int *) ( /* dim=0 */ (__pyx_v_ZS.data + __pyx_t_50 * __pyx_v_ZS.strides[0]) )) = __pyx_v_z_new;
 ...
 *             inc(nz[z_new]) # Aumentar cantidad de palabras asociadas al tpico
 */
          __pyx_t_51 = __pyx_v_z_new;
          __pyx_t_52 = __pyx_v_w;
          (void)((++(*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nzw.data + __pyx_t_51 * __pyx_v_nzw.strides[0]) ) + __pyx_t_52 * __pyx_v_nzw.strides[1]) )))));
 ...
 */
          ...
          __pyx_t_54 = __pyx_v_z_new;
          (void)((++(*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ndz.data + __pyx_t_53 * __pyx_v_ndz.strides[0]) ) + __pyx_t_54 * __pyx_v_ndz.strides[1]) )))));
 ...
 *             inc(nz[z_new]) # Aumentar cantidad de palabras asociadas al tpico             # <<<<<<<<<<<<<<
 *             if (s >= 0):
 *                 inc(nzs[z_new, s]) # Aumentar el seed al tpico.
 */
          __pyx_t_55 = __pyx_v_z_new;
          (void)((++(*((int *) ( /* dim=0 */ (__pyx_v_nz.data + __pyx_t_55 * __pyx_v_nz.strides[0]) )))));
 ...
 *         free(dist_sum)
 */
            __pyx_t_56 = __pyx_v_z_new;
            __pyx_t_57 = __pyx_v_s;
            (void)((++(*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nzs.data + __pyx_t_56 * __pyx_v_nzs.strides[0]) ) + __pyx_t_57 * __pyx_v_nzs.strides[1]) )))));
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_eta, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_rands, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_SW, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_nzs, 1);
...
static PyObject *__pyx_pw_3lda_4_lda_5_loglikelihood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
...
/* Python wrapper */
static PyObject *__pyx_pw_3lda_4_lda_5_loglikelihood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_3lda_4_lda_5_loglikelihood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_nzw = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_ndz = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_nz = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  __Pyx_RefNannySetupContext("_loglikelihood (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ndz)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 6, 6, 1); __PYX_ERR(0, 200, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 6, 6, 2); __PYX_ERR(0, 200, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nd)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 6, 6, 3); __PYX_ERR(0, 200, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_alpha)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 6, 6, 4); __PYX_ERR(0, 200, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_eta)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 6, 6, 5); __PYX_ERR(0, 200, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_loglikelihood") < 0)) __PYX_ERR(0, 200, __pyx_L3_error)
      }
    ...
    __pyx_v_nzw = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nzw.memview)) __PYX_ERR(0, 200, __pyx_L3_error)
    __pyx_v_ndz = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ndz.memview)) __PYX_ERR(0, 200, __pyx_L3_error)
    __pyx_v_nz = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nz.memview)) __PYX_ERR(0, 200, __pyx_L3_error)
    __pyx_v_nd = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nd.memview)) __PYX_ERR(0, 200, __pyx_L3_error)
    __pyx_v_alpha = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_alpha == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 200, __pyx_L3_error)
    __pyx_v_eta = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_eta == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 200, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 200, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("lda._lda._loglikelihood", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3lda_4_lda_4_loglikelihood(__pyx_self, __pyx_v_nzw, __pyx_v_ndz, __pyx_v_nz, __pyx_v_nd, __pyx_v_alpha, __pyx_v_eta);
...
static PyObject *__pyx_pf_3lda_4_lda_4_loglikelihood(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_nzw, __Pyx_memviewslice __pyx_v_ndz, __Pyx_memviewslice __pyx_v_nz, __Pyx_memviewslice __pyx_v_nd, double __pyx_v_alpha, double __pyx_v_eta) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("_loglikelihood", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_nzw.memview)) { __Pyx_RaiseUnboundLocalError("nzw"); __PYX_ERR(0, 200, __pyx_L1_error) }
  if (unlikely(!__pyx_v_ndz.memview)) { __Pyx_RaiseUnboundLocalError("ndz"); __PYX_ERR(0, 200, __pyx_L1_error) }
  if (unlikely(!__pyx_v_nz.memview)) { __Pyx_RaiseUnboundLocalError("nz"); __PYX_ERR(0, 200, __pyx_L1_error) }
  if (unlikely(!__pyx_v_nd.memview)) { __Pyx_RaiseUnboundLocalError("nd"); __PYX_ERR(0, 200, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_3lda_4_lda__loglikelihood(__pyx_v_nzw, __pyx_v_ndz, __pyx_v_nz, __pyx_v_nd, __pyx_v_alpha, __pyx_v_eta, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 200, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"_loglikelihood", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3lda_4_lda_5_loglikelihood, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_nu_sum, __pyx_k_nu_sum, sizeof(__pyx_k_nu_sum), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_sample_topics_interactive, __pyx_k_sample_topics_interactive, sizeof(__pyx_k_sample_topics_interactive), 0, 0, 1, 1},
 ...
 *         for i in range(eta.shape[0]):
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_u_Could_not_allocate_memory_during); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 82, __pyx_L1_error)
 ...
 *     """
 */
  __pyx_tuple__23 = PyTuple_Pack(27, __pyx_n_s_WS, __pyx_n_s_DS, __pyx_n_s_ZS, __pyx_n_s_nzw, __pyx_n_s_ndz, __pyx_n_s_nz, __pyx_n_s_alpha, __pyx_n_s_eta, __pyx_n_s_rands, __pyx_n_s_SW, __pyx_n_s_nzs, __pyx_n_s_nu, __pyx_n_s_i, __pyx_n_s_k, __pyx_n_s_w, __pyx_n_s_d, __pyx_n_s_z, __pyx_n_s_z_new, __pyx_n_s_s, __pyx_n_s_r, __pyx_n_s_dist_cum, __pyx_n_s_N, __pyx_n_s_n_rand, __pyx_n_s_n_topics, __pyx_n_s_eta_sum, __pyx_n_s_nu_sum, __pyx_n_s_dist_sum); if (unlikely(!__pyx_tuple__23)) __PYX_ERR(0, 129, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__23);
  __Pyx_GIVEREF(__pyx_tuple__23);
  __pyx_codeobj__24 = (PyObject*)__Pyx_PyCode_New(12, 0, 27, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__23, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_lda__lda_pyx, __pyx_n_s_sample_topics_interactive, 129, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__24)) __PYX_ERR(0, 129, __pyx_L1_error)
 ...
 *     """
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_3lda_4_lda_3_sample_topics_interactive, NULL, __pyx_n_s_lda__lda); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 129, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_sample_topics_interactive, __pyx_t_1) < 0) __PYX_ERR(0, 129, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
